...
from networks import MLPDeform, MLP, Encoder
...
class INR(pl.LightningModule):
    def __init__(self, coord_size: int, num_subjects: int, max_slices: int, **kwargs):
        ...
        self.encoder = Encoder([32, 64,64,128,128,128], self.latent_size, **kwargs)
    ...
    def regularization_criterion(self, subj_idx: torch.Tensor) \
        ...
        reg_dict = {f"loss_reg": reg_loss,
                    **reg_inr_dict, **reg_aff_dict, **reg_lat_dict, **reg_int_scale_dict}
    ...
    def inference(self, subj_idxs, dset: CardiacUKBBFullImage, dset_str: str = 'val'):
        ...
        for i in tqdm.tqdm(range(100), desc=f"Performing inference for subjects {subj_idxs}"):
