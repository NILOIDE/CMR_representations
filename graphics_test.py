...
im_path = r"D:\logs\20251125-034718-psf20k_100subj-20ann\pred_volumes\epoch_36000\1011525\pred\full.nii.gz"
im = nib.load(im_path)  # Somewhat visible papillary
pad_start = (15, 15, 15)
pad_end = (-15, -15, -15)
...
seg_path = r"D:\logs\20251125-034718-psf20k_100subj-20ann\pred_volumes\epoch_36000\1011525\pred\full_seg.nii.gz"
seg = nib.load(seg_path)  # Somewhat visible papillary
# seg = nib.load(r"D:\logs\20251125-034718-psf20k_100subj-20ann\pred_volumes\epoch_24000\1021869\pred\full_seg.nii.gz")
...
# im_crop_thresh = np.where(seg_crop>0, im_crop, 0.0)
# repl = im_crop[bounds[0][0]: bounds[0][1], bounds[1][0]: bounds[1][1], int(D/5*3):, :]
# im_crop_thresh[bounds[0][0]: bounds[0][1], bounds[1][0]: bounds[1][1], int(D/5*3):, :] = repl
# im_crop = im_crop_thresh
